import { User, UpdateProfile } from "../model/user_model";
...
export interface AuthenticationRepository {
    ...
    getUserByEmail(userEmail: string): Promise<UpdateProfile | null>;
    createUser(user: User): Promise<string | null>;
    updateUserPassword(userEmail: string, newPassword: string): Promise<void>;
    updateUserProfile(user: UpdateProfile, userEmail: string): Promise<string | null>;
}