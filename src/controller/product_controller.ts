...
export class ProductController {
    ...
    async getPaginatedProducts(req: Request, res: Response) {
        try {
            ...
            const products: ProductDisplay[] | null =  await this.productService.getPaginatedProducts(page);
    ...
    async getPaginatedProductsByFilter(req: Request, res: Response) {
        try {
            ...
            const products: ProductDisplay[] | null =  await this.productService.getPaginatedProductsByFilter(filterPage, productPrice, productSize, productCategory, productGender, productBrand);
